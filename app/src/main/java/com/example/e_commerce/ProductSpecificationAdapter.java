...
public class ProductSpecificationAdapter extends RecyclerView.Adapter<ProductSpecificationAdapter.ViewHolder> {
    ...
    public int getItemViewType(int position) {
        switch (productSpecificationModelList.get(position).getType()) {
            ...
            case 1:
                return ProductSpecificationModel.SPECIFICATIONS_BODY;
            default:
                return -1;
    ...
    public ProductSpecificationAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        switch (viewType){
            case  ProductSpecificationModel.SPECIFICATION_TITLE:
                ...
                title.setPadding(setDp(8,parent.getContext()),
            ...
            case  ProductSpecificationModel.SPECIFICATIONS_BODY:
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        private void setFeatures(String featuredetails, String featureTitle){
